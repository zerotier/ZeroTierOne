...
ZeroTier 非常重视我们软件产品和服务的安全性，这包括通过我们的 GitHub 组织管理的所有源代码仓库。

## 支持的版本

以下版本的 ZeroTier One 会收到安全更新：
...
**请不要通过公共 GitHub issues 报告安全问题**

请通过电子邮件将漏洞报告发送至 security@zerotier.com。如果可能，请使用我们的 PGP 密钥（见下文）进行加密。

请包含以下信息，或尽可能提供帮助我们理解问题性质和范围的信息：
